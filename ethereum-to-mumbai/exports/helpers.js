...
const balanceGoerli = async (account) =>
  await tokenRefDERC20Goerli.methods.balanceOf(account).call();
const balanceMumbai = async (account) =>
  await tokenRefDERC20Mumbai.methods.balanceOf(account).call();
