...
const { parentAddressGoerli, childAddressMumbai } = require("./addresses.js");
...
const ws = new WebSocket(
  "wss://rpc-mumbai.maticvigil.com/ws/v1/5a2114d7b78866670897a65a0c00d3f546226bac"
);

// miniABI for token
const miniABI = [
  //Stripped ABI for tokens
  // balanceOf
  {
    constant: true,
...
const tokenRefDERC20Goerli = new web3_parent.eth.Contract(
  miniABI,
  parentAddressGoerli
);
const tokenRefDERC20Mumbai = new web3_child.eth.Contract(
  miniABI,
  childAddressMumbai
);
